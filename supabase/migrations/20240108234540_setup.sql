...
AS $$
DECLARE
  project_url TEXT := current_setting('http://supabase_kong_chatbotui:8000');
  service_role_key TEXT := current_setting('supabase status'); -- full access needed for http request to storage
